...
Ensure that the device is allowed to be an exit node in the [Web GUI](https://login.tailscale.com/)

:::

3. <Highlight color="#25c2a0">Owner</Highlight>: [Share the device](https://tailscale.com/kb/1084/sharing#share-a-machine-with-another-user)
...
5. <Highlight color="#8839ef">Guest</Highlight>: Have tailscale installed on their device (have them also [setup tailscale](./tailnet-setup))
